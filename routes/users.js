...
// Method: Get 
// Description: GE all The user subsciption detail
...
router.get("/subscription-details/:id", (req, res) => {
  ...
  const subscriptionType = (days) => {
      if (user.subscriptionType === "Basics") {
          days += 90;
  ...
  const subscriptionDays = subscriptionType(getDateInDays(user.subscriptionDate));
